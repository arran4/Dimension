...
- `TODO.md` was refreshed into an active-backlog-only tracker (done/obsolete entries removed) to focus current migration on remaining adapter parity, UI integration, performance, and release-readiness work.
